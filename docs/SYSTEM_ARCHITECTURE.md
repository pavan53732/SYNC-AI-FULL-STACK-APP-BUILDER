...
| [AI_MINI_SERVICE_IMPLEMENTATION.md](./AI_MINI_SERVICE_IMPLEMENTATION.md)                           | Complete AI mini service implementation                                |
| [PLATFORM_REQUIREMENTS_ENGINE.md](./PLATFORM_REQUIREMENTS_ENGINE.md)                               | Zero-template approach — Platform requirements & asset generation      |
...
| **Layer 5**   | Build Execution Sandbox — Bundled toolchain, PATH isolation, process env override | [TOOLCHAIN_MANIFEST.md](./TOOLCHAIN_MANIFEST.md), [TOOLCHAIN_ISOLATION.md](./TOOLCHAIN_ISOLATION.md) |
...
| **Toolchain Ownership**  | Build Execution Sandbox | ❌          | ✅              | [TOOLCHAIN_MANIFEST.md](./TOOLCHAIN_MANIFEST.md)                                                   |
| **Build Isolation**      | Build Execution Sandbox | ❌          | ✅              | [TOOLCHAIN_ISOLATION.md](./TOOLCHAIN_ISOLATION.md)                                                 |
| **App Spec Contract**    | AI Construction Engine  | ✅          | ❌              | [STRUCTURED_SPEC_FORMAT.md](./STRUCTURED_SPEC_FORMAT.md)                                           |
| **UI Code Generation**   | AI Construction Engine  | ✅          | ❌              | [UI_GENERATION_RULES.md](./UI_GENERATION_RULES.md)                                                 |
| **Data Code Generation** | AI Construction Engine  | ✅          | ❌              | [DATA_LAYER_GENERATION.md](./DATA_LAYER_GENERATION.md)                                             |
| **Error Repair**         | AI Construction Engine  | ✅          | ❌              | [REPAIR_PATTERNS.md](./REPAIR_PATTERNS.md)                                                         |
