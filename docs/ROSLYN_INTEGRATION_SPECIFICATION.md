...
Schema Definition: The Roslyn service reads and writes to the Semantic Graph defined in `DATABASE_SPECIFICATION.md`. It specifically populates the `syntax_nodes`, `symbols`, and `symbol_edges` tables.
